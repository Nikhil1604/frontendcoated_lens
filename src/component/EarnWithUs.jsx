        ...
        <Grid container height='screen' direction='column' sx={{padding:'30px'}} >
            ...
            <Grid container direction='row' justifyContent='center' sx={{marginTop:'60px'}}>
                ...
                <Grid xs={6} container direction='column' justifyContent='flex-start' >
                    ...
                    <Button component={Link} to='/login' varient='contained' sx={{bgcolor:'#000',color:'#fff',width:'30%',
                    paddingTop:'15px',paddingBottom:'15px',transform:'transition 0.3s ease-in-out','&:hover':{bgcolor:'#000',color:'#fff',scale:'1.05'}}}>Book Now</Button>
                </Grid>
            </Grid>
        </Grid>
    </Box>
